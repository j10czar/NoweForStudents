  ...
  return (
    <div className='home-container faq-container2' id='faq'>
        ...
        <div className='faq-container'>
            <DisclosureBox  title="When are you planning on releasing?" disc="Since I am still a student, I dont have as much time as I would like to work on this. I am aiming for around early February 2023 for a beta release."/>
